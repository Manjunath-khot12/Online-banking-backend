	...
	public void updateAccountBalances(TransactionHistory transactionHistory) {
		...
		try {
			...
			if (transactionHistory.getSourceAccount() != null) {
				...
				List<AccountUserDTO> details=accountRepository.findAccountDetailsByAccountNumber(transactionHistory.getSourceAccount().getAccountNumber());
		        ...
		        String body = "Dear " + firstName + ",\n\n" +
		                      "We are pleased to inform you that your deposit has been successfully credited to your " + accountType + " account. Below are the details of your transaction:\n\n" +
	...
	public void updateWithdrawAccountBalances(TransactionHistory transactionHistory) {
	    try {
	        ...
	        if (!details.isEmpty()) {
	            ...
	            String firstName = userDTO.getFirstName();
	            String accountType = userDTO.getAccountType();
	            long updatedBalance = accountRepository.getBalanceByAccountNumber(accountNumber); // Fetch updated balance
	            long phoneNumber = userDTO.getPhoneNumber();
	            String email = userDTO.getEmail();
	            ...
	            String body = "Dear " + firstName + ",\n\n" +
	                          "We would like to inform you that a withdrawal of " + withdrawalAmount + " has been successfully processed from your " + accountType + " account. Below are the details of your transaction:\n\n" +
	                          "Account Number: " + accountNumber + "\n" +
	                          "Registered Phone Number: " + phoneNumber + "\n" +
	                          "Withdrawn Amount: " + withdrawalAmount + "\n" +
...
public void transferAmount(TransactionHistory transactionHistory) {
    ...
    try {
        ...
        List<AccountUserDTO> sourceDetails = accountRepository.findAccountDetailsByAccountNumber(sourceAccount.getAccountNumber());
        List<AccountUserDTO> destinationDetails = accountRepository.findAccountDetailsByAccountNumber(destinationAccount.getAccountNumber());
        ...
        if (!sourceDetails.isEmpty()) {
            ...
            String sourceBody = "Dear " + sourceFirstName + ",\n\n" +
                                "We would like to inform you that an amount of " + transferAmount + " has been successfully transferred from your " + sourceAccountType + " account. Below are the details of the transaction:\n\n" +
                                "Account Number: " + sourceAccountNumber + "\n" +
                                "Registered Phone Number: " + sourcePhoneNumber + "\n" +
                                "Transferred Amount: " + transferAmount + "\n" +
                                "Available Balance: " + (sourceInitialDeposit )+ "\n\n" +
        ...
        if (!destinationDetails.isEmpty()) {
            ...
            String destinationBody = "Dear " + destinationFirstName + ",\n\n" +
                                      "We would like to inform you that an amount of " + transferAmount + " has been successfully deposited into your " + destinationAccountType + " account. Below are the details of the transaction:\n\n" +
